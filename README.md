...
#### sh -c "\`curl -fsSL https://raw.githubusercontent.com/periodic1236/dotfiles/osx/install.sh \`"
...
```bash
sh -c "`curl -fsSL https://raw.githubusercontent.com/periodic1236/dotfiles/osx/install.sh`" -s ask
```
