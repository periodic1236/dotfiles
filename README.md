...
#### sh -c "\`curl -fsSL https://raw.githubusercontent.com/periodic1236/dotfiles/master/install.sh \`"
...
```bash
sh -c "`curl -fsSL https://raw.githubusercontent.com/periodic1236/dotfiles/master/install.sh`" -s ask
```
